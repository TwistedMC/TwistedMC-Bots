...
public class RepeatCommand extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@Nonnull SlashCommandInteractionEvent event) {
        ...
        if (Objects.equals(event.getSubcommandName(), "repeat")) {
            ...
            if (newRepeating) {
                event.reply(":musical_note:  Repeat mode has been turned off!").queue();
                musicManager.scheduler.repeating = false;
            } else if (!newRepeating){
                event.reply(":musical_note:  Repeat mode has been turned on!").queue();
