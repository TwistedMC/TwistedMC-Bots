...
public class NowPlayingCommand extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@Nonnull SlashCommandInteractionEvent event) {
        ...
        if (Objects.equals(event.getSubcommandName(), "nowplaying")) {
            ...
            event.reply(":musical_note:  Now Playing: `" + info.title + "` by `" + info.author + "`").addActionRow(Button.link(info.uri, "Song Link")).queue();
