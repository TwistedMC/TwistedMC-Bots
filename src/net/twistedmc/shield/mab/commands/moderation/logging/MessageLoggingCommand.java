...
public class MessageLoggingCommand extends ListenerAdapter {

    @Override
    public void onSlashCommandInteraction(@Nonnull SlashCommandInteractionEvent event) {

        if (Objects.equals(event.getSubcommandName(), "messagelog")) {
            ...
            try {
                ...
                event.reply("<:squarechecksolid:1057753652602867813> Message Log Channel Set: " + event.getJDA().getTextChannelById(channelID.getIdLong()).getAsMention()).queue();
                try {
